...
//                "프로젝트명", "설명", 1000, LocalDate.now().plusDays(7), "IT", List.of("url1", "url2")
//        );
//
//        ProjectResponseDto responseDto = new ProjectResponseDto(
//                1L, "작성자", null, "프로젝트명", "설명",
//                1000, LocalDate.now().plusDays(7), "IT", "OPEN", List.of("url1", "url2")
//        );
//
...
//
//        ProjectResponseDto responseDto = new ProjectResponseDto(
//                projectId, "클라이언트", "프리랜서", "프로젝트명", "설명", 1000, LocalDate.now().plusDays(7), "IT", "COMPLETED", List.of("url1", "url2")
//        );
//
//        when(currentUserArgumentResolver.supportsParameter(any(MethodParameter.class))).thenReturn(true);
//        when(currentUserArgumentResolver.resolveArgument(any(), any(), any(), any())).thenReturn(userId);
...
//
//        ProjectRequestDto requestDto = new ProjectRequestDto(
//                 "수정된 프로젝트명", "수정된 설명", 2000, LocalDate.now().plusDays(10), "IT", List.of("url1", "url2")
//        );
//
//        ProjectResponseDto responseDto = new ProjectResponseDto(
